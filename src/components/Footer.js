...
const Footer = () => {
  return (
    <div>
          <footer className="" style={{background: "linear-gradient(rgba(255, 255, 255, 1), rgb(100, 74, 214))"}}>
        <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            <div className="grid grid-cols-2 place-items-center lg:place-items-start gap-8 md:grid-cols-3 lg:grid-cols-4">
                <div>
            ...
            <div className="text-center">
                ...
                <span className="block text-sm text-center text-black-500">© 2023 Tailwind™. All Rights Reserved. Built with <a href="https://github.com/and-lim" className="text-purple-800 hover:underline ">and-lim</a> 
                </span>
                <ul className="flex justify-center mt-5 space-x-5">
                    <li>
                        <a href="#" className="text-black-500 hover:text-purple-900">
                    ...
                    <li>
                        <a href="https://github.com/and-lim" className="text-black-500 hover:text-purple-900 ">
                    ...
                    <li>
                        <a href="" className="text-black-500 hover:text-purple-900 ">
                            <svg className="w-5 h-5" fill="currentcollor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12.001,4.8c-3.2,0-5.2,1.6-6,4.8c1.2-1.6,2.6-2.2,4.2-1.8c0.913,0.228,1.565,0.89,2.288,1.624 C13.666,10.618,15.027,12,18.001,12c3.2,0,5.2-1.6,6-4.8c-1.2,1.6-2.6,2.2-4.2,1.8c-0.913-0.228-1.565-0.89-2.288-1.624 C16.337,6.182,14.976,4.8,12.001,4.8z M6.001,12c-3.2,0-5.2,1.6-6,4.8c1.2-1.6,2.6-2.2,4.2-1.8c0.913,0.228,1.565,0.89,2.288,1.624 c1.177,1.194,2.538,2.576,5.512,2.576c3.2,0,5.2-1.6,6-4.8c-1.2,1.6-2.6,2.2-4.2,1.8c-0.913-0.228-1.565-0.89-2.288-1.624 C10.337,13.382,8.976,12,6.001,12z"/></svg>
                        </a>
                    </li>
                </ul>
            </div>
